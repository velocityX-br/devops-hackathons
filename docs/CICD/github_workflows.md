...
1. Must install the SUGAR GitHub App in their organization
    - https://github.com/marketplace/sugar-github-app | https://github.tools.pppdemands.com/organizations/lab-sit-org/settings/installations/15524
...
Acronym:
- Sugar (Solinas Universal Github Action Runners) is a part of [solinas portfolio](https://wiki.one.int.pppdemands.com/wiki/display/DevFw/Solinas)
...
4. [sugar-service-solinas-hosted-runners](https://pages.github.tools.pppdemands.com/github/features-and-how-tos/features/actions/how-tos/runners/#sugar-service-solinas-hosted-runners)