...
- During pod initiation, openstack call on creating PVC takes long
- dns-relay Pod can run without Bind-landscape-slave SVC and Bind-landscape-slave Pod can't startup without dns-relay forwarding the notify


date 0429: How long does it take to delete a LB and recover (by ArgoCD & Openstack Lbaas ??)