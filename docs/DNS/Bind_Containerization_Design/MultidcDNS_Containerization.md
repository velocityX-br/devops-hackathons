...
> update add ttest.dyn.example.com 60 A 10.0.0.2
> send
> EOF
/ # dig @10.0.0.1 ttest.dyn.example.com
...
ServerSide logs:
```
11-Jul-2025 06:35:09.168 client @0x7f4a700131b8 10.0.0.3#37009/key update-key: signer "update-key" approved
11-Jul-2025 06:35:09.168 client @0x7f4a700131b8 10.0.0.3#37009/key update-key: updating zone 'dyn.example.com/IN': adding an RR at 'ttest.dyn.example.com' A 10.0.0.2
...
```
k run podtest-forwarder --image=cytopia/bind --env="DNS_FORWARDER=10.0.0.4"
```