...
2. `dns-api set hm <vip> <vip_fqdn>` E.g `dns-api hiddenmaster set 10.0.0.1 dnshm-lab.team-a-dev.team-a.int.pppdemands.com`
...
(dnshm01-lab|dnshm-lab) vsa-host001:/etc/dns-api/templates/hiddenmaster #
...
'
13-Mar-2026 01:18:16.135 general: error: zone hellotest.internal/IN/global: NS 'dns01-sit.team-a-dev.team-a.int.pppdemands.com.hellotest.internal' has no address records (A or AAAA)
13-Mar-2026 01:18:16.135 general: error: zone hellotest.internal/IN/global: NS 'dns02-sit.team-a-dev.team-a.int.pppdemands.com.hellotest.internal' has no address records (A or AAAA)
...
你看到的错误是：
NS 'dns01-sit.team-a-dev.team-a.int.pppdemands.com.hellotest.internal' has no address records (A or AAAA)
说明 BIND 认为本 zone 的 NS 是这两台：
dns01-sit.team-a-dev.team-a.int.pppdemands.com.hellotest.internal
dns02-sit.team-a-dev.team-a.int.pppdemands.com.hellotest.internal
...
dns01-sit.team-a-dev.team-a.int.pppdemands.com
