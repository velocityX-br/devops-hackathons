...
```
 => [internal] load metadata for suse.int.repositories.cloud.pppdemands.com/bci/golang:latest                 2.8s
 => [internal] load .dockerignore                                                                  0.0s
 => => transferring context: 2B                                                                    0.0s
 => [builder 1/7] FROM suse.int.repositories.cloud.pppdemands.com/bci/golang:latest@sha256:867c4c22e8c4e48dd  8.3s
 => => resolve suse.int.repositories.cloud.pppdemands.com/bci/golang:latest@sha256:867c4c22e8c4e48dd8fb8ffbc  0.0s
