...
https://example.com/internal-github/sdo-toolsandutilities/gardener-addons
...
https://example.com/internal-pages/kubernetes/gardener/docs/guides/ppp-internal/networking-lb/managed-certs-from-ppp-ca/#configure-a-custom-certificate-issuer
