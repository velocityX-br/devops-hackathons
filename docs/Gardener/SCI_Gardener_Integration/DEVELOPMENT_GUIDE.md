...
```bash
git clone https://example.com/internal-github/redacted/sap-cloud-infrastructure/persephone.git
cd persephone
```
...
- **项目主页**：https://example.com/internal-github/redacted/sap-cloud-infrastructure/persephone
- **问题跟踪**：GitHub Issues
- **文档**：docs/ 目录
